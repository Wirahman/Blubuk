        ...
        <div class="container">
            ...
            <div class="portlet-title">
                <div class="caption">
                    <a class="green" 
                    href="#forum_baru" 
                    data-toggle="modal" data-target="#forum_baru">
                    <i class="fa fa-plus"></i> Buat Forum Baru                
                    </a>
                </div>
            </div>
                                        ...
                                        <table class="table table-bordered table-hover" id="sample_2">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">Isi Forum</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="text-align: center;">
                                                        <?php
                                                        $row->foto_forum;
                                                        $file_ext = strtolower(end(explode('.', $row->foto_forum)));
                                                    ...
                                                    <td style="text-align: center;">
                                                        <?= 
                                                        '<img src="'.base_url().'/images/foto_profil/'.$row->foto_user.'" width="20" height="20" />';
                                                        ?>
                                                        <?php echo $row->name ?>
                                                    </td>
                                                    <td style="text-align: center;">
                                                    ...
                                                    <!-- <div class="modal fade" id="ubah_komentar_forum" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                    </div> -->
                                                    <div class="modal fade" id="hapus_komentar_forum" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                    </div>
                                                </tr>
                                            <?php endforeach; ?>
                                            </tbody>
