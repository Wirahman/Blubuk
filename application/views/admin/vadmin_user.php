                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="portlet box blue-hoki">
                        ...
                        <div class="portlet-body">
                            ...
                            <!-- BEGIN FORM-->
                            <form action="admin" method="post" id="form_buat_status" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">        
                                <div class="form-group">
                                    <div class="col-md-4">
                        ...
                        <div class="portlet-body">
                            <div class="scroller" style="height: 305px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
                                <div class="general-item-list">
                                    ...
                                    <a href="https://www.binerteknologi.com" target="_blank">
                                        <img src="<?php echo base_url(); ?>/images/sponsor/Biner.jpg" width="150px"/>
                                    </a>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="item">
                                                                <div class="item-body">
                                                                    ...
                                                                    <a class="green" 
                                                                    href="<?php echo base_url() . 'admin/komentar_status/' . $row->id; ?>" 
                                                                    data-toggle="modal" data-target="#komentar_status">Komentari                                                                        
                                                                    </a>
                                                                    <a class="green" 
                                                                    href="<?php echo base_url() . 'admin/hapus_status/' . $row->id; ?>" 
