                ...
                <div class="col-md-8 margin-top-20">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-user-md"></i>Masukkan Email Agan...
                            </div>
                            <div class="tools">
                            </div>
                        </div>
                        <div class="portlet-body">                          
                            ...
                            <div class="alert alert-danger display-hide">
                                ...
                                <i class="fa fa-times"></i> Email Agan Belum Terdaftar...
                            </div>
                            ...
                            <!-- BEGIN FORM-->
                            <form method="post" id="form_modal_forgot_password" autocomplete="off" class="form-horizontal">
                                <div class="form-body">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-3 col-md-9">
                                            <button id="submit" type="submit" class="btn blue-hoki"><i class="fa fa-check"></i> Kirim</button>
                                            <button id="cancel" type="submit" class="btn red"><i class="fa fa-times"></i> Batal</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
