                ...
                <div class="col-md-8 margin-top-20 col-centered">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-user"></i>Ganti Email 
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="alert alert-danger display-hide">
                                ...
                                <i class="fa fa-times"></i> Email Tidak Dapat Dirubah...
                            </div>
                            ...
                            <!-- BEGIN FORM-->
                            <form action = "ganti_email" method="post" id="form_ganti_email" autocomplete="off" class="form-horizontal">
                                <div class="form-body">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-5 col-md-9">
                                            <button id="ganti_email" type="submit" class="btn blue-hoki"><i class="fa fa-check"></i> Ganti Email</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<script src="<?php echo base_url(); ?>assets/admin/pages/scripts/blubuk/user/ganti_email.js"></script>
<script>
