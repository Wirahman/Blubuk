                ...
                <div class="col-md-8 margin-top-20">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-user-md"></i>Masukkan Email Anda...
                            </div>
                            <div class="tools">
                            </div>
                        </div>
                        <div class="portlet-body">                          
                            ...
                            <div class="alert alert-danger display-hide">
                                ...
                                <i class="fa fa-times"></i> Email Anda Belum Terdaftar...
                            </div>
                            ...
                            <!-- BEGIN FORM-->
                            <form method="post" id="form_forgot_password" autocomplete="off" class="form-horizontal">
                                <div class="form-body">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-3 col-md-9">
											<span class="help-block">Anda Belum Punya Akun??? Silahkan Melakukan <!-- <a class="text-danger"href="<?php echo site_url('/user/pendaftaran_user_utama') ?>">Pendaftaran</a> -->
                                             <a class="text-danger"href="http://adf.ly/1YpmtC">Pendaftaran</a> Terlebih Dahulu.
											</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-offset-3 col-md-9">
                                            <button id="submit" type="submit" class="btn blue-hoki"><i class="fa fa-check"></i> Send</button>
                                            <button id="cancel" type="submit" class="btn red"><i class="fa fa-times"></i> Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<script src="<?php echo base_url(); ?>assets/admin/pages/scripts/blubuk/user/forgot_password.js"></script>
<script>
