                ...
                <div class="col-md-8 margin-top-20 col-centered">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-sign-in"></i>FORM GANTI EMAIL
                            </div>
                            <div class="tools">
                            </div>
                        </div>
                        <div class="portlet-body">
                            ...
                            <!-- BEGIN FORM-->
                            <form action = "change_email_configuration" method="post" id="form_change_email_configuration" autocomplete="off" class="form-horizontal">
                                <div class="form-body">
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Email Baru <span class="required">
                                        * </span></label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-5 col-md-9">
                                            <button id="change_email_configuration" type="submit" class="btn blue-hoki"><i class="fa fa-check"></i> Ganti Email</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<script src="<?php echo base_url(); ?>assets/admin/pages/scripts/dbexpert/user/change_email_configuration.js"></script>
<script>
