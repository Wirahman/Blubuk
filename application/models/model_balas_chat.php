...
class model_balas_chat extends CI_Model {
	private $table_name;
	
	// Model Constructor
    public function __construct() {
        parent::__construct();
		$this->table_name = "balas_chat";
    }
...
//                exit();
    ...
    function get_all_desc1() {
        $sql = "SELECT a.id, a.id_forum, a.user_id, a.email, a.name, a.foto_user, a.isi, a.foto, a.waktu, a.forum,
        		...
        		from balas_chat a left join forum b on a.id_forum = b.id";
	...
	*/	
	...
	public function get_balas_chat($id)
	{
		$this->db->select('*');
		$this->db->from($this->table_name);
		$this->db->where('id', $id);
