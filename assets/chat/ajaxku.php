...
function renderEmot(statusString) {
	...
	for (var i = 0; i < emotImageMapKeys.length; i ++) {
		...
		renderedString = stringReplaceAll(renderedString, emotImageMapKeys[i], '<img title="'+emotImageMapKeys[i]+'" src="<?php echo $_GET['base_url']; ?>'+emotImageMap[emotImageMapKeys[i]]+'"">');
	}
...
function renderEmotTeman(statusStringTeman) {
	...
	for (var i = 0; i < emotImageMapKeys.length; i ++) {
		console.log('replacing ' + emotImageMapKeys[i] + 'with' + emotImageMap[emotImageMapKeys[i]]);
		renderedStringTeman = stringReplaceAll(renderedStringTeman, emotImageMapKeys[i], '<img title="'+emotImageMapKeys[i]+'" src="<?php echo $_GET['base_url']; ?>'+emotImageMap[emotImageMapKeys[i]]+'"">');
	}
