            ...
            submitHandler: function(form) {
                ...
                if (ext == "pdf" || ext == "jpg" || ext == "jpeg" || ext == "png")
                {
                    ...
                    if (extAcc == "jpg" || extAcc == "jpeg" || extAcc == "png") {
                        ...
                        bootbox.alert("Foto harus diupload");
                        foto.focus();
                        return;
                    } else {
                ...
                {
                    bootbox.alert("File Dokumen KTP harus diupload");
                    fup.focus();
                    return;
                } else
                {
