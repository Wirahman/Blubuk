    ...
    var handleValidation = function () {
        ...
        form.validate({
            ...
            messages: {
                ...
                new_password: {
                    required: "Password Yang Baru Harap Diisi...",
                },
                conf_password: {
                    required: "Konfirmasi Password Harap Diisi...",
                    equalTo: "Konfirmasi Password Harus Sama Seperti Password Anda Yang Baru..."
                }
            },
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    success: function(data){
                            ...
                            window.location.replace('ganti_password');
                        },
                    error: function () {
